...
const Templates = () => {
  ...
  useEffect(() => {
    ...
    const fetchTemplateFiles = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/api/file-templates`, { withCredentials: true });
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_SERVER_URL}/api/file-templates`, formData, {
      ...
      const updatedFiles = await axios.get(`${process.env.REACT_APP_SERVER_URL}/api/file-templates`, { withCredentials: true });
