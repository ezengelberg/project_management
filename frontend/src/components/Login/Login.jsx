...
const Login = () => {
    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            ...
            if (
                process.env.REACT_APP_ROOT_USER === lowerCaseEmail &&
                process.env.REACT_APP_ROOT_PASSWORD === password
            ) {
            ...
            {!showChangePassword && !showForgotPassword ? (
                <Form form={loginForm} onFinish={handleOnSubmit} layout="vertical" className="login-form">
                    ...
                    <div className="form-area">
                        ...
                        {errorMessage && (
                            <Alert className="server-error" message={errorMessage} type="error" showIcon />
                        )}
                    </div>
                </Form>
            ) : showChangePassword ? (
