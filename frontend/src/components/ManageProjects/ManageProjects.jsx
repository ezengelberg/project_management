...
const ManageProjects = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            width:
                windowSize.width > 1920 ? "10%" : windowSize.width > 1600 ? "13%" : windowSize.width > 1200 ? 150 : 150,
        },
        {
            title: "פעולות",
            key: "action",
            ...
            width:
                windowSize.width > 1920 ? "25%" : windowSize.width > 1600 ? "28%" : windowSize.width > 1200 ? 350 : 400,
        },
    ];
            ...
            render: (terminationRecord) =>
                terminationRecord?.map((record, index) => (
                    <span key={record.key}>
                        ...
                        {index < terminationRecord.length - 1 && (
            ...
            <Modal
                ...
                {editRecord.map((record, index) => (
                    <Descriptions
                        ...
                        bordered
                        title={`עריכה ${index + 1}`}
                        column={windowSize.width > 768 ? 2 : 1}>
