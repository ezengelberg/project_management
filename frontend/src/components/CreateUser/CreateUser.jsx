...
const CreateUser = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_SERVER_URL}/api/user/register`, registerValues, {
  ...
  const handleUploadFile = async (file) => {
    Papa.parse(file, {
      ...
      complete: async (result) => {
        ...
        // try {
        //   const response = await axios.post(`${process.env.REACT_APP_SERVER_URL}/api/user/register-many`, result.data, {
        //     withCredentials: true
        //   });
